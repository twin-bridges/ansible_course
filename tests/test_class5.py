...
def test_class5_ex1():
    ...
    cmd_list = ["ansible-playbook", "exercise1.yml", "--forks 12"]
    ...
    for device in ["cisco1", "cisco2", "cisco5", "cisco6", "arista5", "arista6",
                   "arista7", "arista8", "nxos1", "nxos2"]:
